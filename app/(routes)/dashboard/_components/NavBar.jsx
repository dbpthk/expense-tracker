...
//       {/* Mobile Header */}
//       <div className="sticky top-0 z-50 w-screen p-8 flex items-center justify-between backdrop-blur-md bg-white/70 shadow-sm border-b">
...
//       {/* Mobile Drawer */}
//       {isOpen && (
//         <div className="md:hidden fixed h-[100vh] inset-0 bg-white z-40 p-6 pt-20 overflow-y-auto">
//           {renderMenu()}
...
const NavBar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Header */}
      <div className="md:hidden flex items-center justify-between p-4 shadow-md bg-white fixed w-full z-50 top-0 left-0">
        <Link href="/dashboard" className="flex items-center gap-2">
          <Image
            src="/logo.svg"
            alt="logo"
